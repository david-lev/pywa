...
def test_carousel_template_creation_json():
    ...
    cards = [
        MediaCardComponent(
            ...
            buttons=[
                ...
                NewTemplate.UrlButton(title="Shop", url="https://www.luckyshrub.com/rare-succulents/{BLUE_ELF}")
            ]
        ),
        MediaCardComponent(
            header=NewTemplate.Image(example="4::an..."),
            ...
            buttons=[
                NewTemplate.QuickReplyButton(text="Send me more like this!"),
                NewTemplate.UrlButton(title="Shop", url="https://www.luckyshrub.com/rare-succulents{BUDDHA}")
            ]
        ),
        MediaCardComponent(
            header=NewTemplate.Image(example="4::an..."),
            ...
            buttons=[
                NewTemplate.QuickReplyButton(text="Send me more like this!"),
                NewTemplate.UrlButton(title="Shop", url="https://www.luckyshrub.com/rare-succulents{BLACK_PRINCE}")
            ]
        )
    ]
    ...
    assert json.dumps(template.to_dict(), sort_keys=True).lower() == json.dumps(actual, sort_keys=True).lower()


def test_carousel_template_send_json():
    ...
    body_params = [Template.TextValue(value="Pablo"), Template.TextValue(value="20%"), Template.TextValue(value="20OFF")]

    cards = [
        Template.MediaCard(card_index=0, header_asset_id="1558081531584829", header_format="image", quick_reply_payload="more-aloes", url_button_text="blue-elf"),
        Template.MediaCard(card_index=1, header_asset_id="861236878885705", header_format="image", quick_reply_payload="more-crassulas", url_button_text="buddhas-temple"),
        Template.MediaCard(card_index=2, header_asset_id="1587064918516321", header_format="image", quick_reply_payload="more-echeverias", url_button_text="black-prince")
    ]
